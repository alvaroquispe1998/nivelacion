...
@Component({
  ...
  template: `
    <div class="flex items-center justify-between">
      <div>
        <div class="text-xl font-semibold">Registrar asistencia</div>
        <div class="text-sm text-slate-600">Selecciona tu curso-seccion</div>
      </div>
      <button
          ...
          <tr *ngFor="let item of assignments; trackBy: trackItem" class="border-t border-slate-100">
            ...
            <td class="px-4 py-3">
              <a
                ...
                [routerLink]="['/teacher/attendance', item.sectionCourseId]"
              >
                Abrir
              </a>
            </td>
