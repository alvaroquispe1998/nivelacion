...
const ICON = {
  ...
  documentText: `M19.5 14.25v-8.25A2.25 2.25 0 0017.25 3.75H8.25A2.25 2.25 0 006 6v12a2.25 2.25 0 002.25 2.25h5.25m6-6-3 3m0 0-3-3m3 3V10.5M9 8.25h6M9 12h3`,
...
export const ADMIN_SIDEBAR_GROUPS: SidebarGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        route: '/admin/classroom-schedule',
        icon: ICON.clock,
        tooltip: 'Horario por aula',
      },
    ],
  },
    {
  ...
  },
  {
    ...
    items: [
      {
        label: 'Configuración Zoom',
        route: '/admin/zoom/config',
        icon: ICON.cog,
        tooltip: 'Configuración de credenciales y hosts',
        roles: [Role.ADMIN],
      },
      {
        label: 'Reuniones',
        route: '/admin/zoom/meetings',
        icon: ICON.video,
        tooltip: 'Gestión de reuniones Zoom',
        roles: [Role.ADMIN],
      },
    ],
  },
